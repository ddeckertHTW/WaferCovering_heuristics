    ...
    for folder_name, folder_filepath_dict in Folder_MapTypes.items():
        ...
        for inputMapFilepath in folder_filepath_dict:
            for probecard in probecardDict_ForTesting:
                ...
                inputMapFilepath = filepath_bosch_TA660
                probecard = "2x16_Bosch"
                ...
                #Get the Json Data from the normal json File. Not 
                #json_data = load_json_data("C:/Users/Peter/Desktop/Diplomarbeit_Workspace_Programming/PythonProgramming/DATA/Data_TA660/TA660/2x16_DeviceCommander.json")
                json_data = load_json_data("/home/peter2/DA_Bosch_SetCovering/DATA/Data_TA660/TA660/2x16_DeviceCommander.json")
                
                #json_data = load_json_data(get_filepath_Json(inputMapFilepath, probecard, save_folder))
